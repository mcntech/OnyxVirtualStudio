...
COLORREF CStrmListCtrl::OnGetCellTextColor(int nRow, int nColum)
{
	if (!m_bColor)
	{
...
COLORREF CStrmListCtrl::OnGetCellBkColor(int nRow, int nColum)
{
	if (!m_bColor)
	{
	...
	return(nRow % 2) == 0 ? RGB(0x40, 0xA2, 0xE8) : RGB(0x00, 0xA2, 0xE8);
}

HFONT CStrmListCtrl::OnGetCellFont(int nRow, int nColum, DWORD /*dwData* = 0*/)
{
//	if (!m_bModifyFont)
//	{
//		return NULL;
...
int CStrmListCtrl::OnCompareItems(LPARAM lParam1, LPARAM lParam2, int iColumn)
{
